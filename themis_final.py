    ...
    if not df.empty:
        ...
        with d_c1:
            ...
            <div class='cosmos-box' style='border-color:#FF4B4B; height:380px; display:flex; flex-direction:column; justify-content:center;'>
                ...
                <div style='font-size:0.9rem; opacity:0.7; margin:5px 0;'>投行級股王基因 (100分滿分)</div>
        ...
        if ttm_pe > 80:
            ...
            if dragon_index >= 80: t_lv, t_desc, act_desc = "第 1 級", "極致真龍", "【順勢而為】真實財報極度健康，估值雖貴但有強大動能支撐，緊貼趨勢操作。"
            elif dragon_index >= 65: t_lv, t_desc, act_desc = "第 2 級", "潛力金龍", "【價值防守】財報穩健，動能醞釀中，適合分批建倉或持有觀望。"
            elif dragon_index >= 40: t_lv, t_desc, act_desc = "第 3 級", "中庸凡骨", "【謹慎觀望】動能與財報表現平平，估值偏高，注意回調風險。"
            else: t_lv, t_desc, act_desc = "第 4 級", "高危泥鰍", "【規避風險】財報轉弱且動

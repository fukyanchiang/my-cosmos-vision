            ...
            for idx, t in enumerate(tickers_to_scan):
                ...
                try:
                    ...
                    if len(d_full) > 100:
                        ...
                        # 🌟 Fix 4: 零波幅護體 (replace 0.001) in Cyan calculation

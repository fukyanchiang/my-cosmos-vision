...
# =========================================================================
# 🚀 模式 A：個股深度透視 (不按掣、不拉數 + 修復 N/A + cx_val + 所有圖表)
# =========================================================================
        ...
        with st.spinner(f"⏳ 系統正在啟動防封鎖引擎拉取 {ticker} 數據，請稍候..."):
            try:
                ...
                if not df.empty and not spy.empty:
                    ...
                    v21 = df['Volume'].tail(21).mean(); v252 = df['Volume'].mean(); cej_s = safe_n((v21 / max(v252, 1)) * 100, 50.0)

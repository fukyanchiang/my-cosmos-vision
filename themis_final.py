                ...
                for idx, t in enumerate(tickers_to_scan):
                    ...
                    try:
                        ...
                        if len(df_t) > 150:
                            ...
                            valid_dfs[t] = df_t
                            if idx % 5 == 0: time.sleep(0.1) # 爺爺加咗延時避封鎖
                    except: continue
